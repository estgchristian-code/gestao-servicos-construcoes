...
<div>
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-semibold tracking-tight text-slate-900">Novo serviço</h1>
        <p class="mt-1 text-sm text-slate-500">Cadastre um novo serviço da sua empresa.</p>
    </div>
